const genres = {
	...
	"Information": [
		"Emploi", "Médias", "Economie", "Santé", "Débat parlementaire", "Débat", "Politique", "Journal", "Interview","Justice"
	],
	"Documentaire": [
		"Civilisations", "Société", "Nature", "Animalier"
	],
	"Culture": [
		"Beaux-arts", "Conte", "Ballet contemporain", "Ballet", "Ballet classique", "Pièce de théâtre", "Théâtre", "Café-théâtre", "Opéra", "Mode", "Religions", "Sciences et technique"
	],
	"Divertissement": [
		"Sketches", "Poker", "Cirque", "Cérémonie", "One man show", "Décoration", "Loterie", "Talk show", "Jardinage", "Gastronomie", "Télé-achat", "Téléréalité", "Art de vivre", "Jeu", "Spectacle", "Découvertes", "Humour", "Loisirs"
	],
	"Musique": [
		"Concert", "Rock-pop", "Pop & Rock", "Rap & Techno", "Oratorio", "Jazz", "Musique classique", "Variétés", "Musicale", "Classique", "Clips"
	],
	"Jeunesse": [
		"Animation", "Manga", "Dessin animé"
	],
	"Charme": [
